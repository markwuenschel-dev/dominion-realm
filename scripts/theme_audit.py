...
SLATE = {
    ...
    "ink-faint":      (220, 18, 35),
    "accent":         (27, 68, 30),
    "accent-bright":  (240, 37, 36),
    "primary":        (220, 51, 55),
    "primary-fg":     (228, 14, 6),
    "muted-fg":       (220, 30, 26),
    "spectral-ui":    (220, 51, 34),
}
...
SOLSTICE = {
    ...
    "ink-faint":      (213, 40, 37),
    "accent":         (50, 85, 22),
    "accent-bright":  (38, 85, 19),   # post-fix value
    "primary":        (317, 87, 74),
    "primary-fg":     (213, 89, 22),
    "muted-fg":       (213, 60, 30),
    "spectral-ui":    (202, 80, 27),
}
...
HONEYCOMB = {
    ...
    "ink-faint":      (18, 16, 36),
    "accent":         (49, 90, 20),
    "accent-bright":  (46, 85, 18),
    "primary":        (46, 85, 40),
    "primary-fg":     (46, 85, 8),
    "muted-fg":       (33, 25, 26),
    "spectral-ui":    (18, 20, 22),
}
...
MIST = {
    ...
    "ink-faint":      (0, 0, 38),
    "accent":         (172, 94, 20),
    "accent-bright":  (172, 70, 20),
    "primary":        (172, 94, 22),
    "primary-fg":     (162, 38, 95),
    "muted-fg":       (0, 0, 32),
    "spectral-ui":    (172, 94, 21),
}
...
AURORA = {
    ...
    "ink-faint":      (240, 30, 44),
    "accent":         (56, 22, 26),
    "accent-bright":  (42, 100, 16),
    "primary":        (240, 100, 57),
    "primary-fg":     (252, 65, 96),
    "muted-fg":       (240, 25, 30),
