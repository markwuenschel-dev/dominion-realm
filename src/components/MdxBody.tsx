 ...
 * here. `<RevealGate>` lets a single entry layer teaser → reader → deep prose
 * behind the reveal toggle (ADR-0004); it is a client component, rendered inside
 * this server MDX pass — keep gated content presentational.
 */
const mdxComponents = { RevealGate };
