        ...
        <main className="codex-wrap">
          <div className="codex-head">
            ...
            <p className="codex-head__intro">
              One substrate, many interfaces — and many ties. This is the whole codex drawn as a
              single figure: each point is an entry, each line a relationship it declares. Hover a
              point to light its threads, or follow one to its page.
            </p>
