          ...
          <div className="map-page">
            ...
            <figure className="realm-map">
              ...
              >
                ...
                >
                  <rect className="rm-mark__bg" x="416" y="392" width="128" height="34" rx="4" />
                  <text className="hub-name" x={C.x} y="409" textAnchor="middle">
                    Eriadne
                  </text>
                  <text className="hub-kicker" x={C.x} y="421" textAnchor="middle">
                    THE THREAD CITY
                  </text>
                </a>
              ...
              <figcaption className="realm-map__cap">
                ...
                them. Hover a thread to trace it home.
              </figcaption>
            </figure>
                    ...
                    >
                      ...
                      <div>
                        <span className="land-legend__name">
                          {href ? <a href={href}>{m.name}</a> : m.name}
                        </span>
