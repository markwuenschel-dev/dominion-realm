          ...
          <div className="map-page">
            ...
            <figure className="realm-map">
              <div className="realm-map__stage">
                ...
                >
                  ...
                  <desc id="realmMapDesc">
                    ...
                    ruins-portal lies on its outskirts, with the N&apos;hal frontier to the
                    northwest and the Xyloryn swarm to the southeast.
                  </desc>
              ...
              <figcaption className="realm-map__cap">
                ...
                them. Hover a thread to trace it home; select a marked place to open its codex
                entry.
              </figcaption>
            </figure>
